...
+function($, window) { 'use strict';
	$('.btn-delete-modal').submit(function(event){
		var res = confirm('¿Está seguro que desea borrar esto?');
		if(res){
			return true;
		}else{
			return false;
...
$(document).ready(function(){
    $('.url_to').mask('/AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA');
   // $('#url_to').mask('00/00/0000');
});